  ...
  return (
    <section id="order-form" className="px-1 py-14 sm:py-20">
      <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-[#141414] p-6 sm:p-8">
        <h2 className="text-3xl leading-[1.05] text-white sm:text-4xl">
          {t.sectionTitle}
        </h2>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit} noValidate>
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/15 bg-[#1a1a1a] px-4 py-3 text-white outline-none focus:border-accent focus:ring-2 focus:ring-accent/35"
          ...
          <button
            ...
            className="w-full rounded-full bg-accent px-6 py-3 text-base font-black text-black disabled:cursor-not-allowed disabled:opacity-70 hover:shadow-[0_0_24px_rgba(163,230,53,0.42)]"
          >
            {isSubmitting ? t.submitting : t.submit}
          </button>
        </form>

        {isSuccess && <p className="mt-4 text-sm text-accent">{t.success}</p>}
